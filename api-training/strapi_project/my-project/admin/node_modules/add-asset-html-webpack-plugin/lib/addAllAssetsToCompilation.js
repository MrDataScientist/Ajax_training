'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _bluebird;function _load_bluebird() {return _bluebird = require('bluebird');}var _bluebird2;function _load_bluebird2() {return _bluebird2 = _interopRequireDefault(require('bluebird'));}let addFileToAssets = (() => {var _ref = (0, (_bluebird || _load_bluebird()).coroutine)(
  ...
  {let filepath = _ref2.filepath;var _ref2$typeOfAsset = _ref2.typeOfAsset;let typeOfAsset = _ref2$typeOfAsset === undefined ? 'js' : _ref2$typeOfAsset;var _ref2$includeSourcema = _ref2.includeSourcemap;let includeSourcemap = _ref2$includeSourcema === undefined ? true : _ref2$includeSourcema;var _ref2$hash = _ref2.hash;let hash = _ref2$hash === undefined ? false : _ref2$hash,publicPath = _ref2.publicPath,outputPath = _ref2.outputPath;var _ref2$files = _ref2.files;let files = _ref2$files === undefined ? [] : _ref2$files;
    if (!filepath) {
    ...
    if (fileFilters.length > 0) {
      const shouldSkip = !fileFilters.some(function (file) {return (
          (0, (_minimatch || _load_minimatch()).default)(htmlPluginData.outputName, file));});
    ...
    return (_bluebird2 || _load_bluebird2()).default.resolve(null);
  });return function addFileToAssets(_x, _x2, _x3) {return _ref.apply(this, arguments);};})();

// Visible for testing
var _path;function _load_path() {return _path = _interopRequireDefault(require('path'));}var _crypto;function _load_crypto() {return _crypto = _interopRequireDefault(require('crypto'));}var _minimatch;function _load_minimatch() {return _minimatch = _interopRequireDefault(require('minimatch'));}var _handleUrl;function _load_handleUrl() {return _handleUrl = _interopRequireDefault(require('./handleUrl'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ensureTrailingSlash(string) {if (string.length && string.substr(-1, 1) !== '/') {return `${string}/`;}return string;} // Copied from html-webpack-plugin
