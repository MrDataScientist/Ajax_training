<template lang="pug">
el-dialog(v-if="order", :title="'Order logs - ' + order.orderNumber", :visible.sync="showDialog", width="90%", top="5%", @close="onCancel")
  el-table(border, style="width:100%", v-loading.body="loading", :data="logs", :highlight-current-row="false")
    el-table-column(prop="orderLogID", label="ID", width="100")
